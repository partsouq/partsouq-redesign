/* Auto Corner shared cart + order engine.
...
function acctMenuLogout(){
  if (confirm("Log out of Auto Corner?")){
    psBuyerLogout();
...
const PS_SEED_ORDERS = [
  {id:"AC-10234", items:[{name:"Bosch Alternator — 12V 120A", id:"p14", qty:1},{name:"Bosch Brake Pad Set — Front", id:"p5", qty:2}], total:760, status:"Delivered"},
  {id:"AC-10256", items:[{name:"NGK Spark Plug Set", id:"p3", qty:1}], total:100, status:"Out for Delivery"},
  {id:"AC-10261", items:[{name:"AC Compressor Denso", id:"p17", qty:1},{name:"AC Condenser", id:"p19", qty:1}], total:720, status:"Processing"}
];
...
/* details (optional) = {buyer:{name,phone,address,emirate,area}, oldPartPhoto, mulkiya}
   Orders now start life as "Pending Admin Review" — Auto Corner checks the buyer's
...
function psPlaceOrder(details){
  ...
  const order = {
    id: "AC-" + Math.floor(10000 + Math.random() * 89999),
